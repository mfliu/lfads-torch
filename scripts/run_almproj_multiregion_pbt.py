...
HYPERPARAM_SPACE = {
    ...
    "model.kl_co_scale_BS": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.kl_ic_scale_BS": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.l2_gen_scale_BS": HyperParam(1e-6, 10, explore_wt=0.8),
    "model.l2_con_scale_BS": HyperParam(1e-6, 10, explore_wt=0.8),
    
    "model.kl_co_scale_CTX": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.kl_ic_scale_CTX": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.l2_gen_scale_CTX": HyperParam(1e-6, 10, explore_wt=0.8),
    "model.l2_con_scale_CTX": HyperParam(1e-6, 10, explore_wt=0.8),
    
    "model.kl_co_scale_FRP": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.kl_ic_scale_FRP": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.l2_gen_scale_FRP": HyperParam(1e-6, 10, explore_wt=0.8),
    "model.l2_con_scale_FRP": HyperParam(1e-6, 10, explore_wt=0.8),
    
    "model.kl_co_scale_HPF": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.kl_ic_scale_HPF": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.l2_gen_scale_HPF": HyperParam(1e-6, 10, explore_wt=0.8),
    "model.l2_con_scale_HPF": HyperParam(1e-6, 10, explore_wt=0.8),
    
    "model.kl_co_scale_MB": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.kl_ic_scale_MB": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.l2_gen_scale_MB": HyperParam(1e-6, 10, explore_wt=0.8),
    "model.l2_con_scale_MB": HyperParam(1e-6, 10, explore_wt=0.8),
    
    "model.kl_co_scale_TH": HyperParam(1e-3, 10, explore_wt=0.8),
    "model.kl_ic_scale_TH": HyperParam(1e-3, 10, explore_wt=0.8),
